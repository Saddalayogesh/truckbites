...
// ============================================================================
// Resizes every PNG in frontend/truckbites-frontend/public/trucks/ to a max width of
...
const TRUCKS_DIR = path.resolve(__dirname, '..', '..', 'frontend', 'truckbites-frontend', 'public', 'trucks');
const MAX_WIDTH = 800;
const QUALITY = 80;
