...
#   2. bash scripts/reset-vendor-truck-data.sh
#      or: bash scripts/reset-vendor-truck-data.sh --yes   (skip confirmation)
# ============================================================================
...
MYSQL_ROOT_PASSWORD="${MYSQL_ROOT_PASSWORD:-truckbites_root}"
